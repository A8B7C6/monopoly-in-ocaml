  ...
  [
    tiles_list_test "tiles_list_test: full monopoly board" mono
      [
        ...
        make_tile 4 "tax" "Income Tax" 200;
        make_tile 5 "railroad" "Reading Railroad" 200;
